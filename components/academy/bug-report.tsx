...
import { Bug, Send, X, CheckCircle2, Palette, PenLine, Pin, Gauge, ClipboardList } from 'lucide-react';
...
const CATEGORIES: ReadonlyArray<{ value: string; label: string; icon: LucideIcon }> = [
  { value: 'bug', label: 'Bug / Error', icon: Bug },
  { value: 'ui', label: 'UI / Display Issue', icon: Palette },
  { value: 'content', label: 'Content Error', icon: PenLine },
  { value: 'feature', label: 'Feature Request', icon: Pin },
  { value: 'performance', label: 'Slow / Performance', icon: Gauge },
