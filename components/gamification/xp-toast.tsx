        ...
        {toasts.map((toast) => (
          ...
          >
            ...
            <div className="relative flex items-center gap-3">
              ...
              >
                {toast.levelUp ? <Trophy className="h-5 w-5 text-amber-400" /> : toast.type === 'quiz_perfect' ? <Target className="h-5 w-5 text-emerald-400" /> : <Star className="h-5 w-5 text-yellow-400" />}
              </motion.span>
              <div>
                {toast.levelUp ? (
                  <motion.p
