...
export default function DownloadsView() {
  ...
  const texts = {
    ...
    ro: {
      title: 'Descărcări',
      subtitle: 'Produsele tale gata de deployment și certificatele de finalizare',
      thresholdNote: `Finalizează cel puțin ${DOWNLOAD_THRESHOLD}% dintr-un curs pentru a debloca descărcarea.`,
      signInPrompt: 'Autentifică-te pentru a accesa descărcările',
      signIn: 'Autentificare',
      llmSection: 'NeuralForge LLM',
      saasSection: 'Produse GenAI SaaS',
      certificates: 'Certificate de Finalizare',
      download: 'Descarcă ZIP',
      downloadCert: 'Descarcă Certificat',
      generating: 'Se generează...',
      locked: 'Blocat',
      unlocked: 'Disponibil',
      notAvailable: 'În curând',
      notAvailableDesc: 'Pachetul de deployment se pregătește. Revino curând.',
      subscriptionRequired: 'Abonament necesar',
      completionRequired: `Finalizează cel puțin ${DOWNLOAD_THRESHOLD}% pentru a debloca`,
      orgAccess: 'Acces complet prin organizația ta',
      whatsInside: 'Ce conține',
      fileSize: 'Dimensiune',
