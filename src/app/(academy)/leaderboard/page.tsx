...
export default function LeaderboardPage() {
  ...
  const texts = {
    ...
    de: {
      ...
      board: 'Community-Bestenliste',
      emptyBoard: 'Noch niemand ist der Bestenliste beigetreten — sei der Erste!',
      rank: 'Platz', learner: 'Lernende', xp: 'XP', lectures: 'Lektionen',
      you: 'Du',
      settings: 'Bestenlisten-Einstellungen',
      optInLabel: 'Zeige mich in der Bestenliste',
      optInHint: 'Du erscheinst nur, wenn du zustimmst, und nur unter deinem gewählten Alias — niemals mit deinem echten Namen oder deiner E-Mail-Adresse.',
      aliasLabel: 'Anzeigename',
      aliasPlaceholder: 'z. B. NeuralNinja',
      save: 'Speichern', saved: 'Gespeichert!',
      yourStats: 'Deine Statistiken',
      xpEarned: 'Verdiente XP', level: 'Stufe', streak: 'Tage in Folge', lecturesCompleted: 'Abgeschlossene Lektionen',
      signIn: 'Melde dich an, um deinen Fortschritt zu verfolgen und der Bestenliste beizutreten.',
      keepGoing: 'Weiter so!', greatStart: 'Toller Start!', onFire: 'Du bist in Bestform!', master: 'Lernmeister!', noProgress: 'Beginne eine Lektion, um XP zu verdienen!',
    },
    fr: {
      title: 'Classement',
      subtitle: 'Découvrez votre classement parmi les autres apprenants',
      board: 'Classement de la communauté',
      emptyBoard: 'Personne n\'a encore rejoint le classement — soyez le premier !',
      rank: 'Rang', learner: 'Apprenant', xp: 'XP', lectures: 'Leçons',
      you: 'Vous',
      settings: 'Paramètres du classement',
      optInLabel: 'Afficher mon profil dans le classement',
      optInHint: 'Vous n\'apparaissez que si vous l\'activez, et uniquement sous l\'alias choisi — jamais votre vrai nom ou votre e-mail.',
      aliasLabel: 'Alias affiché',
      aliasPlaceholder: 'ex. NeuralNinja',
      save: 'Enregistrer', saved: 'Enregistré !',
      yourStats: 'Vos statistiques',
      xpEarned: 'XP gagnés', level: 'Niveau', streak: 'Jours consécutifs', lecturesCompleted: 'Leçons terminées',
      signIn: 'Connectez-vous pour suivre votre progression et rejoindre le classement.',
      keepGoing: 'Continuez ainsi !', greatStart: 'Excellent début !', onFire: 'Vous êtes en feu !', master: 'Maître de l\'apprentissage !', noProgress: 'Commencez une leçon pour gagner des XP !',
    },
    it: {
      title: 'Classifica',
      subtitle: 'Scopri come ti posizioni rispetto agli altri studenti',
      board: 'Classifica della community',
      emptyBoard: 'Nessuno si è ancora unito alla classifica — sii il primo!',
      rank: 'Posizione', learner: 'Studente', xp: 'XP', lectures: 'Lezioni',
      you: 'Tu',
      settings: 'Impostazioni classifica',
      optInLabel: 'Mostrami nella classifica',
      optInHint: 'Comparirai solo se lo attivi, e solo con l\'alias scelto — mai con il tuo vero nome o la tua email.',
      aliasLabel: 'Alias visualizzato',
      aliasPlaceholder: 'es. NeuralNinja',
      save: 'Salva', saved: 'Salvato!',
      yourStats: 'Le tue statistiche',
      xpEarned: 'XP guadagnati', level: 'Livello', streak: 'Giorni consecutivi', lecturesCompleted: 'Lezioni completate',
      signIn: 'Accedi per monitorare i tuoi progressi e unirti alla classifica.',
      keepGoing: 'Continua così!', greatStart: 'Ottimo inizio!', onFire: 'Sei inarrestabile!', master: 'Maestro dell\'apprendimento!', noProgress: 'Inizia una lezione per guadagnare XP!',
    },
    ar: {
      title: 'لوحة المتصدرين',
      subtitle: 'شاهد ترتيبك مقارنة بزملائك المتعلمين',
      board: 'لوحة متصدري المجتمع',
      emptyBoard: 'لم ينضم أحد إلى لوحة المتصدرين بعد — كن الأول!',
      rank: 'الترتيب', learner: 'المتعلم', xp: 'نقاط الخبرة', lectures: 'المحاضرات',
      you: 'أنت',
      settings: 'إعدادات لوحة المتصدرين',
      optInLabel: 'أظهرني في لوحة المتصدرين',
      optInHint: 'لن تظهر إلا إذا اخترت ذلك، وفقط باسمك المستعار — لن يظهر اسمك الحقيقي أو بريدك الإلكتروني أبدًا.',
      aliasLabel: 'الاسم المستعار المعروض',
      aliasPlaceholder: 'مثال: NeuralNinja',
      save: 'حفظ', saved: 'تم الحفظ!',
      yourStats: 'إحصائياتك',
      xpEarned: 'نقاط الخبرة المكتسبة', level: 'المستوى', streak: 'أيام متتالية', lecturesCompleted: 'المحاضرات المكتملة',
      signIn: 'سجّل الدخول لتتبع تقدمك والانضمام إلى لوحة المتصدرين.',
      keepGoing: 'واصل التقدم!', greatStart: 'بداية رائعة!', onFire: 'أنت في أوج حماسك!', master: 'خبير التعلم!', noProgress: 'ابدأ محاضرة لتبدأ بكسب نقاط الخبرة!',
    },
  };
