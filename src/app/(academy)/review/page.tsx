...
export default function ReviewPage() {
  ...
  const texts = {
    ...
    de: {
      ...
      subtitle: 'Verteiltes Wiederholen bringt Fragen, die du falsch beantwortet hast, in optimalen Abständen zurück – für langfristiges Behalten.',
      dueNow: 'Jetzt Fällig',
      totalInQueue: 'In der Warteschlange',
      difficulty: 'Dein Niveau',
      weakAreas: 'Verbesserungsbereiche',
      noReviews: 'Im Moment stehen keine Wiederholungen an! Komm später wieder oder mache weitere Quiz, um deine Wiederholungsliste aufzubauen.',
      recallPrompt: 'Erinnere dich an die Antwort, decke sie dann auf und bewerte dich ehrlich.',
      showAnswer: 'Antwort Anzeigen',
      correctLabel: 'Richtige Antwort',
      explanationLabel: 'Warum',
      gotIt: 'Richtig Beantwortet',
      needsWork: 'Braucht Mehr Übung',
      nextReview: 'Nächste Wiederholung in',
      days: 'Tagen',
      completed: 'Alles erledigt! Gute Arbeit.',
      unavailable: 'Diese Frage ist nicht mehr verfügbar — bewerte sie, um sie neu zu planen.',
      loading: 'Frage wird geladen…',
      difficultyLabels: { easy: 'Grundlagen Aufbauen', medium: 'Auf Kurs', hard: 'Fortgeschritten' },
    },
    fr: {
      title: 'Révision Intelligente',
      subtitle: 'La répétition espacée fait ressurgir les questions auxquelles tu as échoué à des intervalles optimaux pour une rétention à long terme.',
      dueNow: 'À Réviser',
      totalInQueue: 'Dans la File',
      difficulty: 'Ton Niveau',
      weakAreas: 'Points à Améliorer',
      noReviews: 'Aucune révision à faire pour le moment ! Reviens plus tard ou fais d\'autres quiz pour alimenter ta file de révision.',
      recallPrompt: 'Rappelle-toi la réponse, puis révèle-la et évalue-toi honnêtement.',
      showAnswer: 'Afficher la Réponse',
      correctLabel: 'Bonne réponse',
      explanationLabel: 'Pourquoi',
      gotIt: 'Bonne Réponse',
      needsWork: 'À Retravailler',
      nextReview: 'Prochaine révision dans',
      days: 'jours',
      completed: 'Tout est à jour ! Excellent travail.',
      unavailable: 'Cette question n\'est plus disponible — évalue-toi pour la reprogrammer.',
      loading: 'Chargement de la question…',
      difficultyLabels: { easy: 'Bases en Construction', medium: 'Sur la Bonne Voie', hard: 'Avancé' },
    },
    it: {
      title: 'Ripasso Intelligente',
      subtitle: 'La ripetizione dilazionata ripropone le domande sbagliate a intervalli ottimali per una memorizzazione a lungo termine.',
      dueNow: 'Da Ripassare',
      totalInQueue: 'In Coda',
      difficulty: 'Il Tuo Livello',
      weakAreas: 'Aree da Migliorare',
      noReviews: 'Nessun ripasso in programma al momento! Torna più tardi o svolgi altri quiz per popolare la coda di ripasso.',
      recallPrompt: 'Richiama alla mente la risposta, poi rivelala e valutati con onestà.',
      showAnswer: 'Mostra Risposta',
      correctLabel: 'Risposta corretta',
      explanationLabel: 'Perché',
      gotIt: 'Risposta Corretta',
      needsWork: 'Da Approfondire',
      nextReview: 'Prossimo ripasso tra',
      days: 'giorni',
      completed: 'Tutto in regola! Ottimo lavoro.',
      unavailable: 'Questa domanda non è più disponibile — valuta per riprogrammarla.',
      loading: 'Caricamento della domanda…',
      difficultyLabels: { easy: 'Basi in Costruzione', medium: 'In Linea', hard: 'Avanzato' },
    },
    ar: {
      title: 'المراجعة الذكية',
      subtitle: 'تعيد التكرار المتباعد إظهار الأسئلة التي أخطأت فيها على فترات مثالية لترسيخها في الذاكرة طويلة المدى.',
      dueNow: 'مستحق الآن',
      totalInQueue: 'في قائمة الانتظار',
      difficulty: 'مستواك',
      weakAreas: 'مجالات تحتاج تحسين',
      noReviews: 'لا توجد مراجعات مستحقة الآن! عد لاحقًا أو أكمل المزيد من الاختبارات لبناء قائمة المراجعة.',
      recallPrompt: 'تذكّر الإجابة، ثم اكشف عنها وقيّم نفسك بصدق.',
      showAnswer: 'إظهار الإجابة',
      correctLabel: 'الإجابة الصحيحة',
      explanationLabel: 'السبب',
      gotIt: 'إجابة صحيحة',
      needsWork: 'يحتاج مزيدًا من العمل',
      nextReview: 'المراجعة التالية بعد',
      days: 'أيام',
      completed: 'كل شيء محدث! عمل ممتاز.',
      unavailable: 'هذا السؤال لم يعد متاحًا — قيّم نفسك لإعادة جدولته.',
      loading: 'جارٍ تحميل السؤال…',
      difficultyLabels: { easy: 'بناء الأساس', medium: 'على المسار الصحيح', hard: 'متقدم' },
    },
  };
