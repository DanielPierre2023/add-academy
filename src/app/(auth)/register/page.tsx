...
import { Mail, Lock, GraduationCap, User, School, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // If enrollment code provided, verify the school first
      ...
      // If school enrollment, update the student record directly
      if (schoolId) {
      ...
      <CardContent className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="name">{t('auth_name', language)}</Label>
          ...
          {/* School enrollment code — optional */}
          <div className="space-y-2">
            <Label htmlFor="enrollmentCode">{t('auth_enrollment_code', language)}</Label>
