...
import { Mail, Lock, User, School, AlertCircle, CheckCircle2, ArrowRight } from 'lucide-react';
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (enrollmentCode.trim()) {
        ...
        if (!school) {
          setError('Invalid or unverified enrollment code.');
          setLoading(false);
          return;
        }
        schoolId = school.id;
    ...
    <div className="rounded-2xl border border-[hsl(240_30%_20%)] bg-[hsl(240_40%_8%/0.85)] p-8 shadow-2xl shadow-black/30 backdrop-blur-xl">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="mt-1.5 text-sm text-[hsl(220_20%_60%)]">
          Start your journey into AI & LLMs
        </p>
      </div>
      ...
      {success && (
        <div className="mb-4 flex items-center gap-2 rounded-lg border border-[hsl(38_80%_55%/0.3)] bg-[hsl(38_80%_55%/0.1)] p-3 text-sm text-[hsl(38_80%_70%)]">
          <CheckCircle2 className="h-4 w-4 shrink-0 text-[hsl(38_80%_55%)]" />
          {success}
        </div>
      )}

      {/* OAuth buttons — top placement for conversion */}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1.5">
          <Label htmlFor="name" className="text-xs font-medium text-[hsl(220_20%_65%)]">
            {t('auth_name', language)}
          </Label>
          <div className="relative">
            <User className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[hsl(220_20%_40%)]" />
            <Input
              id="name"
              type="text"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="enrollmentCode" className="text-xs font-medium text-[hsl(220_20%_65%)]">
            {t('auth_enrollment_code', language)}
          </Label>
          <p className="text-[11px] text-[hsl(220_20%_45%)]">
            {t('auth_enrollment_hint', language)}
          </p>
          <div className="relative">
            <School className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[hsl(220_20%_40%)]" />
            <Input
              id="enrollmentCode"
              type="text"
      ...
      <p className="mt-6 text-center text-sm text-[hsl(220_20%_55%)]">
        ...
        <Link href="/login" className="font-medium text-[hsl(38_80%_55%)] hover:text-[hsl(38_80%_65%)] transition-colors">
