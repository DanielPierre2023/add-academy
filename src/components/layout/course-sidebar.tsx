...
export function CourseSidebar() {
  ...
  return (
    <TooltipProvider>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-50 flex h-full w-full flex-col border-r border-border bg-background transition-transform duration-300 ease-in-out lg:z-30 lg:w-80 lg:translate-x-0',
